...
const parser = body.urlencoded({ extended: false }
        ...
        }); app.use('/client', express.static(__dirname + '/client')); app.post('/', parser, function(req, res) {
            var flag = true;
        ...
        Player.list = {}; Player.onConnect = function(socket) { //собственно сокет по которому будем прокидывать данные 
        ...
        var DEBUG = true;
        // проверка на ошибки
        var io = require('socket.io')(serv, {}); io.sockets.on('connection', function(socket) {
